    ...
    return new Scaffold(
      ...
      body: new ListView(
        ...
        children: <Widget>[
          ...
          WorkInputArea(enable: false, value: 'A栋406', height: 188 * ScaleWidth),
          WorkSelect(title: '作业内容:', placeholder: ''),
          WorkInputArea(enable: false, value: '申请原因', height: 188 * ScaleWidth),
          WorkSelect(title: '申请部门防范措施:', placeholder: ''),
          WorkInputArea(enable: false, value: '已配备必要的灭火器和设备', height: 188 * ScaleWidth),
